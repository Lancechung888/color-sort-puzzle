...
| 6 | Meta 回來理由 | **Pass** | Daily 自適應＋首清 +40；連勝里程碑 Day **3/7/14**（幣＋提示）＋下一里程碑 HUD／首屏；首達 3★ **+22**；每 10 關全 3★ chapter chest（+80🪙＋1 hint）；關卡選單顯示缺星＋獎勵預告；**局中 status bar 即時 Moves/Par/★ 預算投影**（`track-perfect`／`track-good`／`track-ok`，掉軌一次 soft haptic＋`.track-drop`／Off N★ float；`#level-stars` 仍顯示 mastery best） |
