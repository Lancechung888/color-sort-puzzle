...
> **Play Console developer account APPROVED** (2026-09-21 Asia/Taipei). **REAL-ADMOB-IDS** wired Android prod units + `USE_TEST_ADS=false`. **#7 Pass** on **DEVICE-THREE-GREEN** Seeker evidence (2026-09-21 ~19:28–19:49 Asia/Taipei): interstitial + rewarded full-watch + `remove_ads` purchase+restore (`GPA.3327-2483-8031-49087`). Mid-pour ads still guarded in source. See `docs/DEVICE_THREE_GREEN.md`. **Production / soft-launch still forbidden** while #1/#3 Partial.
