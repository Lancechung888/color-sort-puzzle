...
（已補）**NATIVE-VC5-INTERNAL-SYNC**／**PLAY-PASTE-VC5-SYNC**已上 — docs 對齊 Play Active `1.0.4-internal-vc5-uncap1tap`／vc5／1.0.4／UNCAP-ONE-TAP；歷史 vc4／vc3／vc2；Active AAB **不含** IAP-PURCHASE-BUSY；accept 兩項；**#7 仍 Fail**；閘門仍 5 Pass／3 Partial／1 Fail；**未**把 #1／#3／#7／#9 標新 Pass。**不宣稱 ship-ready。**
