...
| 結果 | 說明 |
|------|------|
| **不過** | P0①④ 已 Pass；P0②③ 真廣告／`?ad=1` 產線仍 **Blocked**（Play 帳號已過審 2026-09-21；待真 AdMob／Billing 單元＋實機複驗） |
...
| 仍 Blocked | **P0②③**、真 `remove_ads` Billing／StoreKit（Play 帳號已過審；待正式單元＋實機複驗）— 套件標 **BLOCKED**，**不標 Pass** |
