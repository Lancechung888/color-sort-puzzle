...
> Aligns with `docs/PLAY_POST_APPROVAL_CHECKLIST.md` / `MILLION_USER_BAR` — **#7 AdMob Pass** (DEVICE-THREE-GREEN Seeker). **REAL-ADMOB-IDS** (2026-09-21): Android prod App/unit IDs + `USE_TEST_ADS=false` wired in repo; **Pass** via device three green lights (DEVICE-THREE-GREEN) (interstitial, rewarded full-watch, remove_ads purchase+restore). Wiring alone was never enough; Seeker DEVICE-THREE-GREEN now satisfies #7.
> **Do not claim ship-ready** from this doc alone.
> Marker: **NATIVE-VC7-INTERNAL-SYNC** · **NATIVE-VC7-LOCAL-AAB-SYNC** (current internal Active = `1.0.6-internal-vc7-adUnavailable` / vc7 / versionName **1.0.6** / Billing≥8 / prod AdMob / **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**; historical **NATIVE-VC6-INTERNAL-SYNC** · **NATIVE-VC6-LOCAL-AAB-SYNC** = `1.0.5-internal-vc6-iapBusy` / vc6; historical **NATIVE-VC5-INTERNAL-SYNC** = `1.0.4-internal-vc5-uncap1tap` / vc5; historical **NATIVE-VC3-INTERNAL-SYNC** = `1.0.2-internal-vc3-prodAdMob` / vc3; historical vc4 / 1.0.3; historical **NATIVE-INTERNAL-TESTING-SYNC** = `1.0.1-internal-vc2-testids`; #7 Pass (DEVICE-THREE-GREEN Seeker)).
> Also: **PLAY-PASTE-VC7-SYNC** (historical **PLAY-PASTE-VC6-SYNC** / **PLAY-PASTE-VC5-SYNC** / **PLAY-PASTE-VC3-SYNC**) / **INTERNAL-TESTER-SYNC** / **INTERNAL-TESTER-HANWEN-SYNC** — paste docs + tester Gmail honesty (`lancechung@gmail.com` + `hanwen16888@gmail.com` / ColorTube-internal / opt-in URL).
> Honesty: Play Active is **`1.0.6-internal-vc7-adUnavailable`** / **vc7** / **1.0.6**, containing **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE** (published 2026-09-21 ~21:21 Asia/Taipei). The signed AAB was already built on this packaging box (2026-09-21 Asia/Taipei ~21:17): `/workspace/colortube-artifacts/ColorTubeSort-internal-20260921-2117-prodAdMob-vc7-adUnavailable-release.aab` (+ `ColorTubeSort-internal-latest-release.aab` + `play-upload/ColorTubeSort-vc7-adUnavailable.aab`) and uploaded to Play Active; **no AAB rebuild**. Historical Active `1.0.5-internal-vc6-iapBusy` / vc6 (**NATIVE-VC6-INTERNAL-SYNC** · **NATIVE-VC6-LOCAL-AAB-SYNC**) superseded. Script default remains **ANDROID-VERSION-CODE-7** (`versionCode` **7** / `versionName` **1.0.6`). Seeker may still show installed vc6 until device update — that does **not** mean Play Active is vc6. **#7 Pass** (DEVICE-THREE-GREEN Seeker) unchanged. Markers: **NATIVE-VC7-INTERNAL-SYNC** · **NATIVE-VC7-LOCAL-AAB-SYNC**.
...
| **REAL-ADMOB-IDS** Android prod App ID + interstitial/rewarded + `USE_TEST_ADS=false` | **DONE in repo** (2026-09-21 Asia/Taipei). Device three-green **Pass** → **#7 Pass** (DEVICE-THREE-GREEN Seeker) |
| Play Active `versionCode` 7 / `versionName` 1.0.6 (`ANDROID-VERSION-CODE-7`) | **UPLOADED current** (Play Active `1.0.6-internal-vc7-adUnavailable`, **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**). Script default **7** / **1.0.6**. Historical: **vc6** / 1.0.5; **vc5** / 1.0.4; **vc4** / 1.0.3; **vc3** / 1.0.2 |
...
| Release signing + `bundleRelease` AAB | **DONE on this packaging box** (2026-09-19 + **2026-09-21**): `npm run aab:internal` → signed AABs. Durable copies under `/workspace/colortube-artifacts/`: **Play Active uploaded** = vc7-adUnavailable (`ColorTubeSort-internal-20260921-2117-prodAdMob-vc7-adUnavailable-release.aab` / `latest` / `play-upload/ColorTubeSort-vc7-adUnavailable.aab`; **NATIVE-VC7-INTERNAL-SYNC** · **NATIVE-VC7-LOCAL-AAB-SYNC**); historical vc6-iapBusy / vc5-uncap1tap / vc4 / vc3 / vc2 |
| Play `versionCode` / `versionName` | **UPLOADED current** **versionCode 7** / **versionName 1.0.6** (`ANDROID-VERSION-CODE-7`) as `1.0.6-internal-vc7-adUnavailable`; Active includes **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**. Script default remains **7** / **1.0.6** (hooked after Billing-8). Historical: **vc6** / 1.0.5; **vc5** / 1.0.4; **vc4** / 1.0.3; **vc3** / 1.0.2; **vc2** / 1.0.1. |
| Play developer account | **APPROVED** (2026-09-21 Asia/Taipei) — see `docs/PLAY_POST_APPROVAL_CHECKLIST.md` |
| Play **internal testing** track | **UPLOADED current** (2026-09-21 Asia/Taipei ~21:21): release `1.0.6-internal-vc7-adUnavailable` / **versionCode 7** / **versionName 1.0.6** / Billing≥8 / **prod AdMob** (`USE_TEST_ADS=false`) / **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**. Historical: `1.0.5-internal-vc6-iapBusy` / vc6 (superseded; **NATIVE-VC6-INTERNAL-SYNC**); vc5 / 1.0.4; vc4 / 1.0.3; `1.0.2-internal-vc3-prodAdMob` / vc3 (superseded; **NATIVE-VC3-INTERNAL-SYNC**); `1.0.1-internal-vc2-testids` / vc2 (superseded; **NATIVE-INTERNAL-TESTING-SYNC**). Internal tester list **ColorTube-internal** includes `lancechung@gmail.com` + `hanwen16888@gmail.com`; license testers **RESPOND_NORMALLY**; opt-in `https://play.google.com/apps/internaltest/4701709602422954921` (**INTERNAL-TESTER-SYNC** · **INTERNAL-TESTER-HANWEN-SYNC**). **Not** production. **#7 Pass** (DEVICE-THREE-GREEN Seeker). |
| Play Console real AdMob / real IAP IDs / production publish | **Android AdMob IDs wired (REAL-ADMOB-IDS)**; IAP device verify + production publish still open. **#7 Pass** (DEVICE-THREE-GREEN Seeker). Production publish still open. |
...
- [x] `npm install` + `npm run aab:internal` (build:www → `cap sync` → Billing≥8 patch → versionCode **7** patch (`ANDROID-VERSION-CODE-7`) → AdMob Manifest patch → `bundleRelease`; existing signed **vc7-adUnavailable** AAB uploaded to Active; **no AAB rebuild**)
...
- [x] Artifacts under `/workspace/colortube-artifacts/`:
  ...
  - 2026-09-21 ~18:26 (historical **Play Active** upload, superseded): **versionCode 6** / **versionName 1.0.5** + Billing≥8 + **prod AdMob** + **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** — `ColorTubeSort-internal-20260921-1826-prodAdMob-vc6-iapBusy-release.aab` (+ `play-upload/ColorTubeSort-vc6-iapBusy.aab`) (**NATIVE-VC6-INTERNAL-SYNC** · **NATIVE-VC6-LOCAL-AAB-SYNC**). Historical release name: `1.0.5-internal-vc6-iapBusy`.
  - 2026-09-21 ~21:17 (**built and uploaded to Play Active** ~21:21): **versionCode 7** / **versionName 1.0.6** + Billing≥8 + **prod AdMob** + **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE** — `ColorTubeSort-internal-20260921-2117-prodAdMob-vc7-adUnavailable-release.aab` (+ `ColorTubeSort-internal-latest-release.aab` + `play-upload/ColorTubeSort-vc7-adUnavailable.aab`) (**NATIVE-VC7-INTERNAL-SYNC** · **NATIVE-VC7-LOCAL-AAB-SYNC**). Play Active release name: `1.0.6-internal-vc7-adUnavailable`; **no AAB rebuild**.
- [x] **Play developer account APPROVED** (2026-09-21 Asia/Taipei). Prior uploads used versionCodes **1**→**6**; **current** is **vc7**.
- [x] Play **internal testing** track **UPLOADED** (2026-09-21 Asia/Taipei ~21:21): **current** release name `1.0.6-internal-vc7-adUnavailable` / **versionCode 7** / **versionName 1.0.6** / Billing≥8 / **prod AdMob** (`USE_TEST_ADS=false`) / **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**. Historical: `1.0.5-internal-vc6-iapBusy` / vc6 (superseded; **NATIVE-VC6-INTERNAL-SYNC**); vc5 / 1.0.4; vc4 / 1.0.3; vc3 / 1.0.2; vc2 / 1.0.1. Package `com.lancechung.colortubesort`. Internal tester list **ColorTube-internal** includes `lancechung@gmail.com` + `hanwen16888@gmail.com`; license testers **RESPOND_NORMALLY**; opt-in `https://play.google.com/apps/internaltest/4701709602422954921` (**INTERNAL-TESTER-SYNC** · **INTERNAL-TESTER-HANWEN-SYNC**). MILLION_USER_BAR **#7 Pass** is from DEVICE-THREE-GREEN Seeker — not from AAB upload / tester config alone. Seeker may still show installed vc6 until update — Play Active is **vc7**.
...
- [x] Play Console **upload** local `1.0.6-internal-vc7-adUnavailable` AAB (2117 path above; **NATIVE-VC7-INTERNAL-SYNC** · **NATIVE-VC7-LOCAL-AAB-SYNC**) — Active vc7 (historical vc6 upload: **NATIVE-VC6-INTERNAL-SYNC** · **NATIVE-VC6-LOCAL-AAB-SYNC**)
- [ ] Play Console **store listing** / open testing / production (internal testing **vc7-adUnavailable** AAB is Active; testers configured — see **INTERNAL-TESTER-SYNC**; device three green lights **Pass** (DEVICE-THREE-GREEN Seeker))
...
- [x] Device three green lights (interstitial / rewarded full-watch / remove_ads purchase+restore) — **Pass**; #7 Pass (DEVICE-THREE-GREEN Seeker). See `docs/DEVICE_THREE_GREEN.md`
...
See `docs/PLAY_POST_APPROVAL_CHECKLIST.md` / `MILLION_USER_BAR`. **Do not claim the app is published** until listing is live. **#7 Pass** is from DEVICE-THREE-GREEN Seeker only — not from account/Manifest/AAB alone.
...
**DONE (repo + this env):** Capacitor deps, **REAL-ADMOB-IDS** (Android prod App/units + `USE_TEST_ADS=false`), billing skeleton, `index.html` script order, `build:www`, `cap add android` + `cap sync` with both plugins, idempotent Manifest / Billing≥8 / **versionCode 7** patch scripts (`ANDROID-VERSION-CODE-7`), JDK 17 + ANDROID_HOME on this box, signing steps documented, signed internal AABs including **current Play Active** `1.0.6-internal-vc7-adUnavailable` (**UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE** / prod AdMob; **NATIVE-VC7-INTERNAL-SYNC**) plus historical vc6 / vc5 / vc4 / vc3 / vc2, **Play developer account APPROVED** (2026-09-21 Asia/Taipei). The already-built **vc7-adUnavailable AAB** under `/workspace/colortube-artifacts/` (`…-2117-prodAdMob-vc7-adUnavailable-release.aab` / `play-upload/ColorTubeSort-vc7-adUnavailable.aab`) is uploaded as `1.0.6-internal-vc7-adUnavailable` (**NATIVE-VC7-LOCAL-AAB-SYNC**); **no AAB rebuild**. Historical vc6 (`1.0.5-internal-vc6-iapBusy`) superseded (**NATIVE-VC6-INTERNAL-SYNC** · **NATIVE-VC6-LOCAL-AAB-SYNC**).

**NOT ship-ready** (#1/#3 Partial). **#7 Pass** (DEVICE-THREE-GREEN Seeker: interstitial / rewarded full-watch / `remove_ads` purchase+restore). Repo wiring + AAB + tester Gmail alone were never enough. Production untouched. Testers configured (`lancechung@gmail.com` + `hanwen16888@gmail.com` / ColorTube-internal / RESPOND_NORMALLY) — **INTERNAL-TESTER-SYNC** · **INTERNAL-TESTER-HANWEN-SYNC**.
...
### versionCode (Play uploads) — ANDROID-VERSION-CODE-7

- Play rejects reuse of the same `versionCode` (prior uploads used **1**→**6**; **current** Play Active is **7** / `1.0.6-internal-vc7-adUnavailable`). After `cap sync`, run `bash scripts/patch-android-version.sh` (hooked in `npm run aab:internal` after Billing-8, before AdMob) to set **versionCode 7** / **versionName 1.0.6** by default (override via `COLOR_TUBE_VERSION_CODE` / `COLOR_TUBE_VERSION_NAME`). Repo `package.json` `"version"` aligns to **1.0.6**. Accept gates: `ANDROID-VERSION-CODE-7` · `NATIVE-PACK-READY-SYNC` · `NATIVE-VC7-INTERNAL-SYNC` · `NATIVE-VC7-LOCAL-AAB-SYNC` (historical `NATIVE-VC6-INTERNAL-SYNC` · `NATIVE-VC6-LOCAL-AAB-SYNC`). **#7 Pass** is DEVICE-THREE-GREEN Seeker evidence (not this version bump). Active AAB contains **UNCAP-ONE-TAP** + **IAP-PURCHASE-BUSY** + **AD-REWARD-UNAVAILABLE**; **no AAB rebuild**.
